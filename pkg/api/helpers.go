...
// Package api provides the Network Service Mesh api
package api
...
func ServiceNames(impl interface{}, existingServiceNames ...string) []string {
	existingServiceNames = append(existingServiceNames, networkservice.ServiceNames(impl)...)
	existingServiceNames = append(existingServiceNames, registry.ServiceNames(impl)...)
